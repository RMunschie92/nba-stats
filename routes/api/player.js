    ...
    request.get({
      ...
      .on("end", () => {
        ...
        if (completedRequests == urls.length) {
          ...
          if (responses[0].hasOwnProperty('leaguePlayers')) {
            responses = responses.reverse();
          }
          let playerStats = responses[0].seasonalPlayerStats.playerStatsTotals[0].stats;
          let playerData = responses[1].leaguePlayers.players[0].player;
